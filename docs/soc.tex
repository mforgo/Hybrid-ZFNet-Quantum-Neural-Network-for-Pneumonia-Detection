...
% [cite: 98-109]
Literární rešerše. Shrňte současný stav poznání. Důsledně citujte zdroje \cite{sample_ref}. Rozsah cca 1/3 práce.

\chapter{Cíle práce} \label{chap:cile}
% [cite: 110-114]
Definujte hlavní a dílčí cíle. Stanovte hypotézy nebo výzkumné otázky.

\chapter{Metodika / Experimentální část} \label{chap:metodika}
% [cite: 115-122]
