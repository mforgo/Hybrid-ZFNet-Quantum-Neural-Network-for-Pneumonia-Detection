...
\begin{titlepage}
    \begin{center}
        ...
        % Code and Title
        \LARGE \kodPrace \ \textbf{\nazevPrace} \\ % 
        \vspace{0.5cm}
        
        % Subtitle
        \Large \textit{\podNazev} \\ % 
        \vspace{2cm}

        % School Year
        \Large Školní rok \skolniRok \\ % [cite: 379]
        
        \vfill
    \end{center}

    % Authors aligned to the bottom or specific layout
    \begin{flushleft}
        \Large
        \textbf{Autor:} \\
        \autor, \trida \\ % 
        \vspace{0.5cm}
        \textbf{Vedoucí práce:} \konzultant % [cite: 388]
    \end{flushleft}
\end{titlepage}
